...
function clicou(n) {
    ...
    if (elNumero !== null) {
        ...
        playSound('sound-tecla'); // Toca o som da tecla
    }
    }
...
function branco() {
    if (numero === '') { // Verifica se nenhum número foi digitado
        ...
        playSound('sound-confirma'); // Toca o som de confirmação
    } else {
...
function confirma() {
    ...
    if (votoConfirmado) { // Se o voto foi confirmado
        ...
        if (etapas[etapaAtual] !== undefined) {
            ...
            const audio = new Audio('https://www.youtube.com/watch?v=RFbkKwz1ijA');
    audio.play();
        } else {
